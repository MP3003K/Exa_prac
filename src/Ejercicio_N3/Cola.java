...
public class Cola {
	...
	/*
	 * En realidad, si estamos seguro de que nadie llamará a este método podriamos
	 * ponerla como no synchronized
	 */
	...
	/*
	 * Igual que antes, si estamos seguro de que nadie llamará a este método
	 * podriamos ponerla como no synchronized
	 */
	...
	public synchronized int desencolar() {
		/*
		 * Necesitamos un número especial que actúe como comprobador de errores
		 */
		if (estaVacia()) {
			return -1;
		}
